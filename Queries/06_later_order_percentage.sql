-- ================================================
-- Query: Late Delivery Percentage
-- Author: Shashank Ojha
-- ================================================

-- Business Question:
-- What percentage of delivered orders arrived
...
-- Key Finding:
-- 8% of delivered orders were late
-- Direct comparison of actual vs estimated
-- delivery date used for accuracy
